...
<title>Flowers MasForU Website</title>
...
<section class="flowers" id="flowers" >
 ...
 <br>
    <form action="tri-flowers.php" method="GET">
  ...
  <table>
		...
		<tr>
           ...
           <form action="" method="post" class="box">
                    ...
                    <input type="hidden" name="product_price" value="<?php echo $fetch_products['price']; ?>">
                    <input type="hidden" name="product_image" value="<?php echo $fetch_products['image']; ?>">
				<td class="quantity"><input id="product" type="number" class="quantity" value="<?php echo $fetch_products['quantity']; ?>" min="1" ></td>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        <div class="box">
            ...
            <p>I received a flower arrangement and it was in a lovely vase. The flowers were beautiful and following the directions for care, they lasted a long time. Love your service and friendliness. I was very pleased with the arrangement and so was the recipient!</p>
            <div class="user">
        ...
        <div class="box">
            ...
            <p>Thank you for creating such a beautiful arrangement of a variety of green plants. I received the gift from my children, two days before Mother's Day, and I was very pleased! The roses were beautiful, almost a week later and they still are gorgeous!</p>
            <div class="user">
        ...
        <div class="box">
            ...
            <p>I want to thank you for a very nice job you did for my daughter's funeral. You are a amazing person. You even have my five year old neice a bracket to see a smile on her face in that time of sarrow. I will recommend you to anyone who ask about a nice florist's.</p>
            <div class="user">
